        ...
        <div className='movie'>
         ...
         <ul>
          {movies && movies.map((movie)=>(
            ...
            <li>
              {movie.video && <img className='movie_backdrop' src={`${movie.backdrop_path}`} ></img>}
              {!movie.video && <img className='movie_backdrop' src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} ></img>}<br/><br/>
